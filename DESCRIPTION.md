...
The game logic, dashboard logic, data recording system, and project structure were implemented for this course project. No third-party source code was copied directly into the project.
